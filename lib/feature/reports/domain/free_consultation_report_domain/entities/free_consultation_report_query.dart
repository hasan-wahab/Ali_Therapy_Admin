...
// ============================================================
// FREE CONSULTATION REPORT QUERY (Domain)
// ------------------------------------------------------------
// All query params for GET /api/admin/reports/free-consultation
// ============================================================

/// Per-page dropdown (matches the web free consultation report).
class FreeConsultationReportPerPage {
  FreeConsultationReportPerPage._();
...
class FreeConsultationReportQuery extends Equatable {
  const FreeConsultationReportQuery({
    this.search = '',
    this.fromDate,
    this.toDate,
    this.consultantId,
    this.clinicId,
    this.perPage = FreeConsultationReportPerPage.defaultSize,
    this.page = 1,
  });
  ...
  FreeConsultationReportQuery copyWith({
    String? search,
    String? fromDate,
    String? toDate,
    int? consultantId,
  ...
  FreeConsultationReportQuery resetFilters() => FreeConsultationReportQuery(
        search: search,
        perPage: perPage,
        page: 1,
      );
  ...
  Map<String, dynamic> toQueryParameters() {
    ...
    if (perPage != FreeConsultationReportPerPage.defaultSize) {
