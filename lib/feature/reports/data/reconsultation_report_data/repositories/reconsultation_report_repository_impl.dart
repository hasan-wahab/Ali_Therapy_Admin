...
// ============================================================
// RECONSULTATION REPORT REPOSITORY IMPL (Data)
// ============================================================

class ReconsultationReportRepositoryImpl
    implements ReconsultationReportRepository {
  ...
  ResultFuture<ReconsultationReportPageEntity> getReconsultationReportPage({
    ...
    if (!await networkInfo.ensureConnected()) {
      ...
      AppErrorLogger.logFailure(
        failure,
        where: 'ReconsultationReportRepository.getReconsultationReportPage',
      );
    ...
    try {
      final model =
          await remoteDataSource.getReconsultationReportPage(query: query);
