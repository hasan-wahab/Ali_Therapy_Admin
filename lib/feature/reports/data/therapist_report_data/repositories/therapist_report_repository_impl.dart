...
// ============================================================
// THERAPIST REPORT REPOSITORY IMPL (Data)
// ============================================================
  ...
  ResultFuture<TherapistReportPageEntity> getTherapistReportPage({
    ...
    if (!await networkInfo.ensureConnected()) {
      ...
      AppErrorLogger.logFailure(
        failure,
        where: 'TherapistReportRepository.getTherapistReportPage',
      );
      return Result.failure(failure);
    }

    try {
      final model = await remoteDataSource.getTherapistReportPage(query: query);
