...
// ============================================================
// ASSISTANT MANAGER REPORT REPOSITORY IMPL (Data)
// ============================================================

class AssistantManagerReportRepositoryImpl
    implements AssistantManagerReportRepository {
  ...
  ResultFuture<AssistantManagerReportPageEntity> getAssistantManagerReportPage({
    ...
    if (!await networkInfo.ensureConnected()) {
      ...
      AppErrorLogger.logFailure(
        failure,
        where: 'AssistantManagerReportRepository.getAssistantManagerReportPage',
      );
    ...
    try {
      final model =
          await remoteDataSource.getAssistantManagerReportPage(query: query);
