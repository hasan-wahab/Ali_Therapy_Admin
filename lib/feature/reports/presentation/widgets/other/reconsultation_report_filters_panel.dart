...
// ============================================================
// RECONSULTATION REPORT FILTERS PANEL
// ------------------------------------------------------------
...
class ReconsultationReportFiltersPanel extends StatefulWidget {
  const ReconsultationReportFiltersPanel({
    super.key,
  ...
  final ReconsultationReportQuery currentQuery;
  final VoidCallback? onApplied;

  @override
  State<ReconsultationReportFiltersPanel> createState() =>
      _ReconsultationReportFiltersPanelState();
}

class _ReconsultationReportFiltersPanelState
  ...
  @override
  void didUpdateWidget(covariant ReconsultationReportFiltersPanel oldWidget) {
  ...
  ReconsultationReportQuery _draftQuery() {
  ...
  ReconsultationReportQuery get _normalizedApplied => ReconsultationReportQuery(
        search: widget.currentQuery.search,
  ...
  void _applyFilters() {
    ...
    context.read<ReconsultationReportBloc>().add(
          ReconsultationReportFiltersApplied(
  ...
  Widget _fromDateField() {
    return ReportDateField(
      key: ValueKey('rc_from_$_resetToken'),
      label: 'From Date',
  ...
  Widget _toDateField() {
    return ReportDateField(
      key: ValueKey('rc_to_$_resetToken'),
      label: 'To Date',
  ...
  Widget _consultantField() {
    return AppDropdownField(
      compact: true,
      key: ValueKey('rc_consultant_$_resetToken'),
      label: 'Consultant',
  ...
  Widget _clinicField() {
    return AppDropdownField(
      compact: true,
      key: ValueKey('rc_clinic_$_resetToken'),
      label: 'Clinic',
