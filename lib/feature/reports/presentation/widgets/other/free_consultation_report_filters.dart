...
// ============================================================
// FREE CONSULTATION REPORT FILTERS
// ------------------------------------------------------------
// Consultant + clinic in one row, dates, Reset (UI only).
// ============================================================

class FreeConsultationReportFilters extends StatelessWidget {
  const FreeConsultationReportFilters({super.key});
