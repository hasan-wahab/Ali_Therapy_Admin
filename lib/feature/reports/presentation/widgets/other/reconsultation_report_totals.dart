...
import 'package:ali_therapy_admin/feature/reports/presentation/widgets/other/reconsultation_report_stat_card.dart';
import 'package:ali_therapy_admin/feature/reports/presentation/widgets/other/report_stats_cards_grid.dart';

// ============================================================
// RECONSULTATION REPORT TOTALS
// ------------------------------------------------------------
// Same open/close chrome as ConsultationReportTotals.
// Expanded body: total reconsultations + per-clinic cards.
// ============================================================

class ReconsultationReportTotals extends StatelessWidget {
  const ReconsultationReportTotals({
    super.key,
                  ...
                  child: expanded
                      ? Padding(
                          ...
                          child: ReportStatsCardsGrid(
                            children: [
                              ReconsultationReportStatCard(
                                title: 'Total Reconsultations',
                                value: '${summary.totalReconsultations}',
                              ...
                              for (var i = 0; i < summary.clinics.length; i++)
                                ReconsultationReportStatCard(
                                  ...
                                  value:
                                      '${summary.clinics[i].reconsultations}',
                                  subtitle: 'Reconsultations',
                                  accentColor:
