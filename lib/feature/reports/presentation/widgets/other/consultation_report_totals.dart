...
import 'package:ali_therapy_admin/feature/reports/presentation/widgets/other/consultation_report_stat_card.dart';
import 'package:ali_therapy_admin/feature/reports/presentation/widgets/other/report_stats_cards_grid.dart';

// ============================================================
// CONSULTATION REPORT TOTALS
// ------------------------------------------------------------
// Same open/close chrome as ReceptionistReportTotals.
// Expanded body: total consultations + per-clinic cards.
// ============================================================

class ConsultationReportTotals extends StatelessWidget {
  const ConsultationReportTotals({
    super.key,
                            ...
                            children: [
                              ...
                              for (var i = 0; i < summary.clinics.length; i++)
                                ConsultationReportStatCard(
                                  ...
                                  value: '${summary.clinics[i].consultations}',
