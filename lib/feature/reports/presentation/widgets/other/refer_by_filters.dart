...
class ReferByFilters extends StatefulWidget {
  const ReferByFilters({
    super.key,
  ...
  final ReferByReportQuery currentQuery;
  final VoidCallback? onApplied;

  @override
  State<ReferByFilters> createState() => _ReferByFiltersState();
}

class _ReferByFiltersState extends State<ReferByFilters> {
  static const _allClinics = 'All clinics';
  static const _allReceptionists = 'All receptionists';
  static const _allReferralTypes = 'All Referral Types';
  ...
  @override
  void didUpdateWidget(covariant ReferByFilters oldWidget) {
  ...
  String? _referralTypeValue(String name) {
    if (name == _allReferralTypes) return null;
    return name;
  }
  ...
  ReferByReportQuery _draftQuery() {
  ...
  ReferByReportQuery get _normalizedApplied => ReferByReportQuery(
        search: widget.currentQuery.search,
  ...
  void _applyFilters() {
    ...
    context.read<ReferByReportBloc>().add(
          ReferByReportFiltersApplied(
            ...
            clearReferralType: draft.referralType == null,
          ),
        );
      ...
      child: Column(
        ...
        children: [
          ...
          AppTabletFieldsGrid(
            ...
            children: [
              ReportDateField(
                key: ValueKey('rb_from_$_resetToken'),
                label: 'From Date',
                valueText: _displayDate(_fromDateApi),
                onTap: _pickFrom,
              ),
              ReportDateField(
                key: ValueKey('rb_to_$_resetToken'),
                label: 'To Date',
              ...
              AppDropdownField(
                compact: true,
                key: ValueKey('rb_clinic_$_resetToken'),
                enableSearch: true,
                label: 'Clinic',
              ...
              AppDropdownField(
                compact: true,
                key: ValueKey('rb_rece_$_resetToken'),
                enableSearch: true,
                label: 'Receptionist',
              ...
              AppDropdownField(
                compact: true,
                key: ValueKey('rb_ref_$_resetToken'),
                enableSearch: true,
                label: 'Referral Type',
                hintText: _allReferralTypes,
