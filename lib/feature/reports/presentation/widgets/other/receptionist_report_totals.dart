...
import 'package:ali_therapy_admin/feature/reports/presentation/widgets/other/receptionist_report_stat_card.dart';
import 'package:ali_therapy_admin/feature/reports/presentation/widgets/other/report_stats_cards_grid.dart';

// ============================================================
// RECEPTIONIST REPORT TOTALS
// ------------------------------------------------------------
// Same open/close chrome as DiscountReportTotals.
// Expanded body: total visits + per-clinic visit cards.
// ============================================================

class ReceptionistReportTotals extends StatelessWidget {
  const ReceptionistReportTotals({
    super.key,
