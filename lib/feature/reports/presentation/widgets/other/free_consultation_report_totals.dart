...
import 'package:ali_therapy_admin/feature/reports/presentation/widgets/other/free_consultation_report_stat_card.dart';
import 'package:ali_therapy_admin/feature/reports/presentation/widgets/other/report_stats_cards_grid.dart';

// ============================================================
// FREE CONSULTATION REPORT TOTALS
// ------------------------------------------------------------
// Same open/close chrome as ReconsultationReportTotals.
// Expanded body: total free consultations + per-clinic cards.
// ============================================================

class FreeConsultationReportTotals extends StatelessWidget {
  const FreeConsultationReportTotals({
    super.key,
                  ...
                  child: expanded
                      ? Padding(
                          ...
                          child: ReportStatsCardsGrid(
                            children: [
                              FreeConsultationReportStatCard(
                                title: 'Total Free Consultations',
                                value: '${summary.totalFreeConsultations}',
                              ...
                              for (var i = 0; i < summary.clinics.length; i++)
                                FreeConsultationReportStatCard(
                                  ...
                                  value:
                                      '${summary.clinics[i].freeConsultations}',
